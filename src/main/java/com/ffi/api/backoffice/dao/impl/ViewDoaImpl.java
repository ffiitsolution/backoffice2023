...
public class ViewDoaImpl implements ViewDao {
    ...
    public List<Map<String, Object>> loginJson(ParameterLogin ref) {
        String qry = "select S.REGION_CODE,O.TRANS_DATE,G.DESCRIPTION REG_NAME,S.OUTLET_CODE,O.OUTLET_NAME,S.STAFF_CODE,S.STAFF_NAME,S.STAFF_FULL_NAME,S.ID_CARD,S.POSITION,S.GROUP_ID,O.CITY  "
                + "from M_STAFF S "
